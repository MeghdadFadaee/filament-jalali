@php
    ...
    $extraAlpineAttributeBag = method_exists($field, 'getExtraAlpineAttributeBag')
    ...
    >
        ...
        @else
            <div
                ...
                {{
                    $extraAlpineAttributeBag->merge([
                        'data-weekdays-short' => $extraAttributeBag->get('data-weekdays-short', 'short'),
                    ])
                }}
            >
                ...
                <button
                    ...
                    "
                    x-on:keydown.arrow-left.prevent.stop="if (! $el.disabled) focusNextDay()"
                    x-on:keydown.arrow-right.prevent.stop="if (! $el.disabled) focusPreviousDay()"
